...
def Procesar_TXT_Consolidados():
    ...
    CertificadosIVA = CertificadosIVA.drop_duplicates()
    ...
    CertificadosIVA = CertificadosIVA.sort_values(by=["Hasta Periodo"] , ascending=False )
    CertificadosIVA = CertificadosIVA.sort_values(by=["CUIT"] , ascending=True )
    ...
    # Eliminar los duplicados por 'CUIT', 'Denominación' y 'Desde Periodo' y quedarse con el primero
    CertificadosIVA = CertificadosIVA.drop_duplicates(subset=['CUIT', 'Denominación' , 'Desde Periodo'] , keep='first')
